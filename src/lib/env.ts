...
// Proceso para obtener opciones de flujo (ej: qué métodos mostrar en el flujo 03)
// ID real según Postman:
export const PROC_FLOW_OPTIONS = process.env.NEXT_PUBLIC_FLOW_OPTIONS_PROCESS_ID;
